...
Note that strategies where a single action is assigned with probability 1 and the others with probability 0 are called \textit{pure strategies}. For instance, $x_2$ is a pure strategy. \\ 
